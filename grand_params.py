...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 16 14:03:46 2022
...
def GRAND_params(args):
    ...
    # GNN args
    parser.add_argument('--hidden_dim', type=int, default=args.hidden_channels, help='Hidden dimension.')
    ...
    parser.add_argument("--max_nfe", type=int, default=1e10,
    ...
    GRAND_opt = vars(parser.parse_args())
    
    try:
        best_opt = best_params_dict[args.dataset]
        opt = {**GRAND_opt, **best_opt}
        merge_cmd_args(GRAND_opt, opt)
    except KeyError:
        opt = GRAND_opt
